...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value = ''
        Entry(width=17, bg='#ccddff', font=('Impact',28), textvariable=self.equation).place(x=0, y=0)

        Button(width=11, height=4, text='(', relief='flat', bg='white', command=lambda:self.show('(')).place(x=0, y=50)
        Button(width=11, height=4, text=')', relief='flat', bg='white', command=lambda:self.show(')')).place(x=90, y=50)
        Button(width=11, height=4, text='%', relief='flat', bg='white', command=lambda:self.show('*1/100')).place(x=180, y=50)
        ...
        Button(width=11, height=4, text='=', relief='flat', bg='light green', command=self.solve).place(x=270, y=350)
